// Its acutally easier to extend TikiTorch, to accomodate a fake command line, in in this case, we create the Suspended Process
// However, we don't care or need to overwrite with an actual cmdline. the fake one should suffice.
